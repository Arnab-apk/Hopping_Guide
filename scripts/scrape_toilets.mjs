...
async function fetchOsmToilets() {
  ...
  console.warn('Could not reach Overpass API, continuing with curated Kolkata toilet hubs.');
  return [];
}
...
const metroToilets = [
  // Line 1: Blue Line
  { id: 'metro_dakshineswar', name: 'Dakshineswar Metro Station Public Toilet', lat: 22.6536, lng: 88.3582 },
  ...
  { id: 'metro_howrah', name: 'Howrah Railway Station Metro Public Toilet', lat: 22.5845, lng: 88.3427 },
...
const kmcPublicToilets = [
  ...
  { id: 'kmc_bagbazar_ghat', name: 'KMC Public Toilet — Bagbazar Launch Ghat', lat: 22.6042, lng: 88.3621 },
  ...
  { id: 'kmc_babughat', name: 'Sulabh Shauchalay Complex — Babughat Bus Terminus', lat: 22.5638, lng: 88.3418 },
  { id: 'kmc_prinsep_ghat', name: 'KMC Public Toilet — Strand Road / Prinsep Ghat', lat: 22.5562, lng: 88.3341 },
  ...
  // Howrah Hubs
  { id: 'kmc_howrah_station_cab', name: 'Howrah Station Cab Road Public Toilet Complex', lat: 22.5848, lng: 88.3435 },
